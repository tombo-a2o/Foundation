...
typedef void (*CGContextDelegateCallback)(CGContextDelegateRef);
typedef struct CGCallback {

	CGContextDelegateType type;
    CGContextDelegateCallback delegateAddr;
...
CG_EXTERN void CGContextDelegateSetCallback(CGContextDelegateRef ctxDelegate, CGContextDelegateType type, CGContextDelegateCallback callback);
//CG_EXTERN void CGContextDelegateSetCallbacks(CGContextDelegateRef ctxDelegate, const CGCallback* dlArray, int count);
